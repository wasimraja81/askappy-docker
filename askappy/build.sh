...
# Securely builds askappy (tostool and aces-apps) image using local Git 
# credentials
#####################################################################
...
build_check_push() {
    ...
    if [[ $fatal_failed -eq 0 ]]; then
        ...
        echo -e "  2. Update the appropriate requirements.txt file (e.g., askappy/requirements.txt) to include the missing package."
